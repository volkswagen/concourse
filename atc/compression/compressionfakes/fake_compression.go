...
type FakeCompression struct {
	...
	NewReaderStub        func(io.ReadCloser) (compression.Reader, error)
	newReaderMutex       sync.RWMutex
	newReaderArgsForCall []struct {
		arg1 io.ReadCloser
	}
	newReaderReturns struct {
		result1 compression.Reader
		result2 error
	}
...
func (fake *FakeCompression) NewReader(arg1 io.ReadCloser) (compression.Reader, error) {
...
func (fake *FakeCompression) NewReaderCalls(stub func(io.ReadCloser) (compression.Reader, error)) {
	fake.newReaderMutex.Lock()
...
func (fake *FakeCompression) NewReaderReturns(result1 compression.Reader, result2 error) {
	fake.newReaderMutex.Lock()
	defer fake.newReaderMutex.Unlock()
...
func (fake *FakeCompression) NewReaderReturnsOnCall(i int, result1 compression.Reader, result2 error) {
	fake.newReaderMutex.Lock()
	defer fake.newReaderMutex.Unlock()
	fake.NewReaderStub = nil
